...
#define STRING_CONFIG_H_AUTHOR "(DarO, 02.2020r)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //My Settings
  #define DEFAULT_bedKp 122.88
  #define DEFAULT_bedKi 24.19
  #define DEFAULT_bedKd 416.06
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 160, 900, 295.73 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -0.9 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 23  // X point for Z homing when homing all axes (G28). ((X_BED_SIZE) / 2) 
  #define Z_SAFE_HOMING_Y_POINT 5   // Y point for Z homing when homing all axes (G28). ((Y_BED_SIZE) / 2)
#endif
